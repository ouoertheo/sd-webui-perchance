...
Once you have the proxy up, in Stable Diffusion WebUI, select the Perchance script, put in the name of the desired generator then click Refresh. Put in `{perchance}` into the prompt, and it will be replaced with the generated perchance output.
